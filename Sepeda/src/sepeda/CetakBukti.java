 ...
 * @author achma
 */
public class CetakBukti extends javax.swing.JFrame {
    ...
    void BuktiPembayaran()
    {
        try{
            ...
            InputStream filePath = getClass().getResourceAsStream("/report/BuktiPembayaran.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CetakBukti.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CetakBukti().setVisible(true);
            }
        });
    }
