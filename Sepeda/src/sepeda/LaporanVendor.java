 ...
 * @author achma
 */
public class LaporanVendor extends javax.swing.JFrame {

    /**
     * Creates new form LaporanStok
     */
    public LaporanVendor() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {
            CetakLaporanVendor frm = new CetakLaporanVendor(month, year);
            frm.setVisible(true);
        }        
...
//        frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LaporanVendor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
